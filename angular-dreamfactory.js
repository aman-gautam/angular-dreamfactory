...
//            }
            ...
            var obj = {
                ...
                on: {
                    ...
                    response: function(resp) {
                        ...
                        if (!resp.hasOwnProperty('obj') && !resp.hasOwnProperty('data')) {
                            responseObj = resp;
                        }else {
                            responseObj = resp.obj || JSON.parse(resp.data);
                        }
        ...
        var SwaggerResource = function(resourceObj, api) {
            ...
            this.httpClient = api.httpClient || null;
...
//              this.basePath = response.basePath.indexOf("http") === -1 ? this.getAbsoluteBasePath(response.basePath) : response.basePath;
        ...
        SwaggerOperation.prototype["do"] = function(args, opts, callback, error) {
            ...
            if (opts.mock != null) {
                ...
                // changed to return promises from
        ...
        var SwaggerRequest = function(type, url, params, opts, successCallback, errorCallback, operation, execution) {
            ...
            this.httpClient = operation.resource.httpClient || null;
        ...
        SwaggerHttp.prototype.execute = function(obj) {
            ...
            switch(obj.httpClient.type) {
                ...
                case 'angular':
                    return new AngularHttpClient().execute(obj);
        ...
        var AngularHttpClient = function() {
        ...
        AngularHttpClient.prototype.execute = function(obj) {
            ...
            if (obj.url.lastIndexOf('api_docs') == '-1' && obj.httpClient.promises) {
                ...
                $http({
                    ...
                    return obj.on.response(result);

                }).error(function(reject) {

                    return obj.on.error(reject);
                });
            }
        };
        ...
        SwaggerAuthorizations.prototype.apply = function(obj, authorizations) {
            ...
            if(typeof authorizations === 'undefined' || Object.keys(authorizations).length == 0) {
                ...
                for(var name in authorizations) {
                    for (key in this.authz) {
                        if(key == name) {
        ...
        return {
            ...
            swaggerInit: function () {
                ...
                e.authorizations.add("X-DreamFactory-Application-Name", new e.ApiKeyAuthorization("X-DreamFactory-Application-Name", DSP_API_KEY, "header"));
